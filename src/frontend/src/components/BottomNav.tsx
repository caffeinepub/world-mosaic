    ...
    <>
      ...
      >
        <div className="max-w-lg mx-auto flex items-center justify-around h-16 px-2">
          ...
          <Link
            to="/explore"
            data-ocid="bottom_nav.explore.link"
            className={`flex flex-col items-center gap-1 px-3 py-1 rounded-xl transition-colors ${
              isActive("/explore")
                ? "text-primary"
                : "text-muted-foreground hover:text-foreground"
          ...
          <button
            ...
            className="flex flex-col items-center gap-1 px-3 py-1 rounded-xl text-muted-foreground hover:text-primary transition-colors"
          >
